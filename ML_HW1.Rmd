...
From the `earth` documentation: "If the response is binary or a factor, consider using the `glm` argument...`glm=NULL` (default) or a list of arguments to pass on to glm...Example: `earth(..., glm=list(family=binomial))`"
